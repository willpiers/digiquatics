...
describe 'Private Lessons' do
	...
	before do
		sign_in user
		FactoryGirl.create(:private_lesson, first_name: 'my_lesson', user_id: user.id, preferred_location: location.id )
		FactoryGirl.create(:private_lesson, first_name: 'other_user_lesson', user_id: user.id - 1, preferred_location: location.id)
	end
