  ...
  describe 'signup' do
    ...
    describe 'with valid information' do
      before do
        ...
        check 'sunday_morning'
        check 'sunday_afternoon'
        check 'sunday_evening'
        check 'monday_morning'
        check 'monday_afternoon'
        check 'monday_evening'
        check 'tuesday_morning'
        check 'tuesday_afternoon'
        check 'tuesday_evening'
        check 'wednesday_morning'
        check 'wednesday_afternoon'
        check 'wednesday_evening'
        check 'thursday_morning'
        check 'thursday_afternoon'
        check 'thursday_evening'
        check 'friday_morning'
        check 'friday_afternoon'
        check 'friday_evening'
        check 'saturday_morning'
        check 'saturday_afternoon'
        check 'saturday_evening'
