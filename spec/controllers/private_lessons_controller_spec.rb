...
#   # PrivateLesson. As you add validations to PrivateLesson, be sure to
#   # adjust the attributes here as well.
#   let(:valid_attributes) { { "first_name" => "MyString" } }

#   # This should return the minimal set of values that should be in the session
#   # in order to pass any filters (e.g. authentication) defined in
#   # PrivateLessonsController. Be sure to keep this updated too.
#   let(:valid_session) { {} }

#   describe "GET index" do
#     it "assigns all private_lessons as @private_lessons" do
